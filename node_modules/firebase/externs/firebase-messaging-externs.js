 ...
 *
 * @return {firebase.Promise<void>} The promise resolves if permission is
 ...
 * to get a new token.
 *
 * @param {!firebase.Subscribe} subscriber The functions passed in are
 *   called when a token refresh has occured.
 * @return {firebase.Unsubscribe} To stop listening for token
 *   refresh events, call this unsubscribe method.
 */
firebase.messaging.Messaging.prototype.onTokenRefresh = function(subscriber) {};
 ...
 *
 * @param {!firebase.Subscribe<Message>} subscriber The functions passed in
 *   are called when a token refresh has occured.
 * @return {firebase.Unsubscribe} If you wish to stop listening for messages,
 *   call this unsubscribe method.
 */
 ...
 * @return {firebase.Promise<void>} The promise resolves when the token has been
